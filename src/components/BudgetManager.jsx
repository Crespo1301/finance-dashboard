...
function BudgetManager({ budgets, setBudgets, transactions }) {
  ...
  return (
    <div className="bg-white p-6 sm:p-8 rounded-xl shadow-lg border border-gray-100">
      <h2 className="text-2xl font-bold mb-6 text-gray-800">Budget Goals</h2>
      ...
      <form onSubmit={handleSetBudget} className="mb-6 p-4 bg-gray-50 rounded-lg">
        <div className="flex flex-col sm:flex-row gap-3">
          <select
            ...
            className="flex-1 px-4 py-2 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-blue-500 bg-white"
          >
      ...
      <div className="space-y-4">
        {Object.keys(budgets).length === 0 ? (
          ...
          Object.entries(budgets).map(([category, budget]) => {
            ...
            return (
              <div key={category} className="p-4 border-2 border-gray-100 rounded-lg">
